...
<body>
    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li>
            <a href="index.php" class="nav-link px-3 nav-text">Recenzje</a>
          </li>
          <li>
            <a href="formularz.php" class="nav-link px-3 nav-text">Oceń grę</a>
          </li>
		...
		?>
          <li>
            <a href="autorzy.php" class="nav-link px-3 nav-text">Autorzy</a>
          </li>
        </ul>
        <!-- 
  ...
  <div class="container">
    <div class="display-2 mb-4">Autorzy projektu:</div>
    <ul class="display-6">
      <li>Jakub Dalmata</li>
      <li>Maciej Ciukaj</li>
    </ul>
